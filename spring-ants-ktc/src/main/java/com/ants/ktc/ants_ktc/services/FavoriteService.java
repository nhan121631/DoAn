...
// public Page<FavoriteRoomProjection> getFavoriteRooms(String username,
// Pageable pageable) {
// User user = userJpaRepository.findByUsername(username)
// .orElseThrow(() -> new EntityNotFoundException("User not found with username:
// " + username));

// return favoriteJpaRepository.findByUserIdWithRoom(user.getId(), pageable)
// .map(favorite -> new FavoriteRoomProjection() {
// @Override
// public UUID getId() {
// return favorite.getRoom().getId();
// }

// @Override
// public String getTitle() {
// return favorite.getRoom().getTitle();
// }
