...
public interface UserJpaRepository extends JpaRepository<User, UUID> {
        ...
        /**
         * ML
         * Find user by username with full profile and address for ML processing
         * Ensures all necessary data is eagerly loaded to avoid lazy loading issues
         */
        @Query("""
                            SELECT u FROM User u
                            LEFT JOIN FETCH u.profile p
                            ...
                            WHERE u.username = :username
                        """)
        Optional<User> findByUsernameForML(@Param("username") String username);
