    ...
    >
      ...
      <div className="relative w-full h-[60%] min-h-[180px] max-h-[220px] select-none">
        ...
        <div className="absolute z-30 flex gap-2 top-3 left-3">
          {isForSale && (
            <span className="px-3 py-1 text-xs font-semibold text-white bg-green-700 rounded-full shadow group-hover:scale-105 group-hover:shadow-lg transition-all duration-300">
              FOR SALE
            </span>
          )}
          {isFeatured && (
            <span className="px-3 py-1 text-xs font-semibold text-white bg-yellow-500 rounded-full shadow group-hover:scale-105 group-hover:shadow-lg transition-all duration-300">
              FEATURED
            </span>
          )}
        </div>
      ...
      <div className="flex flex-col justify-between h-[40%] p-4 bg-white">
        <div>
          <div className="mb-1 text-lg font-bold text-gray-900 truncate group-hover:text-amber-700 transition-colors duration-200">
            {room.title || "No Title"}
          </div>
          <div className="flex items-center gap-2 mb-2 text-sm text-gray-600 group-hover:text-gray-800 transition-colors duration-200">
        ...
        <div className="flex items-center justify-between mt-2">
          <div className="flex items-center gap-2 text-sm text-gray-700 bg-gray-100 px-2 py-1 rounded-lg group-hover:bg-amber-100 transition-colors duration-200">
            <PiRuler className="text-base" />
            <span>{room.area} m²</span>
          </div>
          <div className="text-lg font-extrabold text-amber-600 group-hover:text-amber-700 transition-colors duration-200">
