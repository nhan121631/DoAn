...
export default function ContractOverview({ contract, onContractUpdate, autoEdit }: ContractOverviewProps) {
  ...
  const handleSubmit = async (values: any) => {
    try {
      ...
      const updatedContract = await ContractService.updateContract(contract.id, updateData);
