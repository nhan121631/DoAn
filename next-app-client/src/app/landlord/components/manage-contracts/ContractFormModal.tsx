...
// import { ContractData, ContractFormValues } from "@/types/types";
...
//       });
//       setSelectedFileName(
//         editingContract.contractImageUrl
//           ? editingContract.contractImageUrl.split("/").pop()
//           : undefined
//       );
//     } else {
//       form.resetFields();
...
//         formattedStartDate = dayjs(values.startDate, "MM/DD/YYYY").format(
//           "MM/DD/YYYY"
//         );
//       }
//     }
