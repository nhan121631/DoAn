      ...
      {selectedBill && (
        <div className="bg-white dark:bg-[#001529] p-6 h-full transition-colors duration-300">
          ...
          <div className="text-center mb-6 border-b dark:border-gray-600 pb-4 transition-colors duration-300">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2 transition-colors duration-300">RENTAL BILL</h2>
            <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">RENTAL BILL</p>
          ...
          <div className="mb-6">
            <h3 className="text-lg font-semibold mb-3 text-gray-700 dark:text-gray-200 transition-colors duration-300">CUSTOMER INFORMATION</h3>
            <div className="bg-gray-50 dark:bg-[#22304a] p-4 rounded-lg transition-colors duration-300">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <span className="font-medium text-gray-600 dark:text-gray-300 transition-colors duration-300">Name: </span>
                  <p className="text-gray-800 dark:text-white font-bold text-lg transition-colors duration-300">{contract?.tenantName}</p>
                </div>
                <div>
                  <span className="font-medium text-gray-600 dark:text-gray-300 transition-colors duration-300">Phone:</span>
                  <p className="text-gray-800 dark:text-white font-bold text-lg transition-colors duration-300">{contract?.tenantPhone}</p>
                </div>
                <div>
                  <span className="font-medium text-gray-600 dark:text-gray-300 transition-colors duration-300">Room:</span>
                  <p className="text-gray-800 dark:text-white transition-colors duration-300">{contract?.roomTitle}</p>
                </div>
                <div>
                  <span className="font-medium text-gray-600 dark:text-gray-300 transition-colors duration-300">Month:</span>
                  <p className="text-gray-800 dark:text-white font-semibold text-red-600 dark:text-red-400 transition-colors duration-300">{selectedBill.month}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Chi tiết hóa đơn */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold mb-3 text-gray-700 dark:text-gray-200 transition-colors duration-300">BILL DETAILS</h3>
            <div className="border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden transition-colors duration-300">
              <table className="w-full">
                <thead className="bg-gray-100 dark:bg-[#17223b] transition-colors duration-300">
                  <tr>
                    <th className="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-200 transition-colors duration-300">Item</th>
                    <th className="text-right py-3 px-4 font-semibold text-gray-700 dark:text-gray-200 transition-colors duration-300">Amount</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-t dark:border-gray-600 transition-colors duration-300">
                    <td className="py-3 px-4 text-gray-700 dark:text-gray-300 transition-colors duration-300">Electricity</td>
                  ...
                  <tr className="border-t dark:border-gray-600 bg-gray-50 dark:bg-[#22304a] transition-colors duration-300">
                    <td className="py-3 px-4 text-gray-700 dark:text-gray-300 transition-colors duration-300">Water</td>
                    <td className="py-3 px-4 text-right text-gray-800 dark:text-white transition-colors duration-300">
                      {selectedBill.waterFee?.toLocaleString('vi-VN')} đ
                    </td>
                  </tr>
                  <tr className="border-t dark:border-gray-600 transition-colors duration-300">
                    <td className="py-3 px-4 text-gray-700 dark:text-gray-300 transition-colors duration-300">Service Fee</td>
                    <td className="py-3 px-4 text-right text-gray-800 dark:text-white transition-colors duration-300">
